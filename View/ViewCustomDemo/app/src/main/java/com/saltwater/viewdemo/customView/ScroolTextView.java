 ...
 * </pre>
 */
public class ScroolTextView extends android.support.v7.widget.AppCompatTextView {
    int oldX, oldY;


    public ScroolTextView(Context context) {
        super(context);
    }

    public ScroolTextView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public ScroolTextView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
